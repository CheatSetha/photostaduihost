...
import { fetchRoles, selectAllRoles } from "@/redux/features/role/roleSlice";
...
const FormAddNew = () => {
  ...
  const handleInsertImgToServer = async (image) => {
    ...
    try {
      const respone = await fetch(
        "http://136.228.158.126:8002/api/v1/images",
        requestOptions
      );
  ...
  const createUser = async (values, imgId) => {
