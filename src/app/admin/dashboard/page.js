					...
					<div className='col-span-1 bg-white flex justify-between w-full  p-4  rounded-main dark:bg-secondary'>
						<div className='flex flex-col w-full pb-4'>
							<h1 className='text-2xl font-bold dark:text-white'>
								{" "}
								Active user{" "}
								<span className='text-[17px] font-light'>| This Month</span>
							</h1>
					...
					<div className='col-span-1 bg-white flex justify-between w-full  p-4 rounded-main dark:bg-secondary'>
						<div className='flex flex-col w-full pb-4'>
							<h1 className='text-2xl font-bold dark:text-white'>
								{" "}
								Unread Requests{" "}
								<span className='text-[17px] font-light'>| Today</span>
							</h1>
							<div className='flex mt-4 dark:text-white'>
								<div className='bg-blue-300 rounded-full w-[80px] h-[80px] object-cover flex items-center justify-center'>
									<span className='  text-[50px] '>
								...
								<div className='flex mt-4'>
									<div className='mt-1 ml-5'>
										<ol class='relative border-l border-gray-200 dark:border-gray-700 '>
											<li class='mb-5 ml-6'>
												<span class='absolute flex items-center justify-center w-3 h-3 bg-blue-100 rounded-full -left-2 ring-8 ring-white dark:ring-gray-900 dark:bg-cyan-500'></span>
												<time class='block mb-2 text-sm font-normal leading-none text-light dark:text-white'>
													Released on January 13th, 2023
												</time>
												<p class='mb-2 text-base font-normal text-gray-500 dark:text-white'>
													{" "}
													Generate Watermark two min ago{" "}
												</p>
											</li>
											<li class='mb-5 ml-6'>
												<span class='absolute flex items-center justify-center w-3 h-3 bg-blue-100 rounded-full -left-2 ring-8 ring-white dark:ring-gray-900 dark:bg-red-500'></span>
												<time class='block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-white'>
													Released on December 18th, 2023
												</time>
												<p class='text-base font-normal text-gray-500 dark:text-white'>
													Generate certificate 2 min ago
												</p>
											</li>
											<li class='mb-5 ml-6'>
												<span class='absolute flex items-center justify-center w-3 h-3 bg-blue-100 rounded-full -left-2 ring-8 ring-white dark:ring-gray-900 dark:bg-yellow-500'></span>
												<time class='block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-white'>
													Released on December 7th, 2023
												</time>
												<p class='text-base font-normal text-gray-500 dark:text-white'>
													Generate watemark 3 min ago
												</p>
											</li>
											<li class='mb-5 ml-6'>
												<span class='absolute flex items-center justify-center w-3 h-3 bg-blue-100 rounded-full -left-2 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-500'></span>
												<time class='block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-white'>
													Released on December 7th, 2023
												</time>
												<p class='text-base font-normal text-gray-500 dark:text-white'>
													Generate certificate 4 h ago
												</p>
											</li>
											<li class='ml-5'>
												<span class='absolute flex items-center justify-center w-3 h-3 bg-blue-100 rounded-full -left-2 ring-8 ring-white dark:ring-gray-900 dark:bg-orange-500'></span>
												<time class='block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-white'>
													Released on December 2nd, 2023
												</time>
												<p class='text-base font-normal text-gray-500 dark:text-white'>
								...
								<div className='flex mt-4'>
									<div className='ml-5 '>
										<h1>
											Google{" "}
											<progress
												className='progress progress-secondary w-56 ml-5 md:w-[100px]'
												value='90'
												max='100'
											></progress>{" "}
										</h1>
										<h1>
											YouTube{" "}
											<progress
												className='progress progress-info w-56 ml-3 md:w-[100px] max-sm:ml-2'
												value='70'
												max='100'
											>
												{" "}
										...
										<h1>
											Bing{" "}
											<progress
												className='progress progress-primary w-56 ml-10 md:w-[100px] '
												value='40'
												max='100'
											></progress>
										</h1>
