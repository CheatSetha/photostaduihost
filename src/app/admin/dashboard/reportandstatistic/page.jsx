    ...
    <div className={"w-full p-5 mx-auto h-full dark:bg-primary"}>
      ...
      <div className="h-full xl:h-screen">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          ...
          <div
            className={
              "bg-white shadow-sm dark:bg-secondary  lg:col-span-2 row-span-2 flex flex-col mainround h-[350px]  justify-center items-center "
            }
          >
            <div className={"w-full h-[90%] p-2.5 py-4 "}>
              ...
              <div className="flex w-full gap-x-32 items-center space-x-8">
                <DoughnutChart certificate={data?.totalOfGeneratedCertificate} watermark={data?.totalOfEditedPhoto} />
