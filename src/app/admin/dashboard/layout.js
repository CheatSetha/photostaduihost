    ...
    return (
        <div className='bg-light dark:bg-secondary'>
            ...
            <aside
                ...
                aria-label='Sidebar'
            >
                <div className='h-full px-3 py-4 overflow-y-auto bg-black  dark:bg-secondary'>
                        ...
                        <li>
                            <Link href={"/admin/dashboard/tutorialmanagement"}>
                                ...
                                >
                                    ...
                                    />
                                    <span
                                        className='flex-1 ml-3 uppercase whitespace-nowrap  font-medium text-white  hover:bg-secondary  dark:text-white dark:hover:bg-gray-700'>
										tutorial management
									</span>
                                    <svg
                                        class='w-6 h-6'
