      ...
      <section className="flex flex-wrap   mt-5">
        ...
        <div className={"max-sm:w-full lg:ms-32 "}>
          <div className="pf-user mt-5">
            ...
            <img
              className="w-36 mb-2 mx-auto h-36 object-cover rounded-full"
              src={
                session
                  ? session.user.image
          ...
          <textarea className="dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-red-400 h-28 dark:focus:border-red-400 dark:shadow-sm-light bg-[whitesmoke] w-full md:w-[400px] rounded-[16px]"></textarea>
        </div>
      </section>
      <button
        className="mainround p-2.5 hover:text-white hover:shadow-2xl hover:shadow-blue-600 hover:bg-[#23c483] hover:-translate-y-2 transform transition-all duration-300 ease-in-out
                                bg-[#E85854] hidden md:block text-white font-[35px] text-center py-2  rounded-[16px]  text-[17px"
      >
        save change
      </button>
    </div>
